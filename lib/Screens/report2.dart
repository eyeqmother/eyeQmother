...
class ReportWidget2 extends StatefulWidget {
  const ReportWidget2({super.key});

  @override
  State<ReportWidget2> createState() => _ReportWidget2State();
}

class _ReportWidget2State extends State<ReportWidget2>
